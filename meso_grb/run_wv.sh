...
export time=`ls -1 /home/ldm/data/grb/fulldisk/09/OR_ABI-L1b-RadF-M3C09_* | tail -1`

sleep 71

echo $time

cd /home/poker/goes16/fulldisk_grb

/home/poker/miniconda3/envs/goes16_201710/bin/python goes16_GRB_fulldisk_wv.py $time
