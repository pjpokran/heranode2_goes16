...
ax9.set_extent((-86.0,-62.0,22.5,51.0))
...
text9 = ax9.text(0.50, 0.95, time_string,
    ...
    color='orange', fontsize='large', weight='bold')
...
filename9="/whirlwind/goes16/test/"+ctime_file_string+".jpg"
...
fig9.savefig(filename9, bbox_inches='tight',pad_inches=0, facecolor='black', edgecolor='none')
...
import glob
file_list = glob.glob('/whirlwind/goes16/grb/meso_wvl/*' + list_string)
file_list.sort()
